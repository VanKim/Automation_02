...
class LoginPage:
    ...
    def input_username_field(self, username):
        self.driver.find_element(*self.__username__).send_keys(username) #*self.__userName__ unpack tuple to 2 args

    def input_password_field(self, password):
        self.driver.find_element(*self.__password__).send_keys(password)

    def clear_username_field(self):
        self.driver.find_element(*self.__username__).clear()

    def clear_password_field(self):
        self.driver.find_element(*self.__password__).clear()

    def click_login_button(self):
        self.driver.find_element(*self.__button__).click()

    def press_enter_login_button(self):
        self.driver.find_element(*self.__button__).send_keys(Keys.ENTER)
